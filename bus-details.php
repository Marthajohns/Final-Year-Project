...
<a class="text-danger mr-3" href="listing"><i class="icofont-rounded-left"></i></a>
Bus Details
</h5>
...
<div class="w-100">
<h6 class="my-1 l-hght-18 font-weight-bold">Niloy Poribohon</h6>
...
<p class="m-0"><i class="icofont-google-map mr-1 text-danger"></i><span class="small">Dhaka to Bogura</span></p>
...
<a href="select-seat" class="btn btn-danger btn-block zinniabus-btn rounded-1">Book Your Seats Now</a>
</div>
